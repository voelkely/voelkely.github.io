...
let monsterImage : string [] = ["imgs/i.png", "imgs/h.png", "imgs/b.png", "imgs/m.jpg", "imgs/t.jpg", "imgs/k.jpg", "imgs/elefant.png", "imgs/loewe.png", "imgs/pinguin.png"];
...
window.onload = function () {
    document.getElementById("fightAllMonster").addEventListener("click", fightAllMonsters);
    document.getElementById("fightAllWeakMonster").addEventListener("click", fightAllWeakMonsters);
